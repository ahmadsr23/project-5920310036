...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="submit" name="checkInternships" class="btn btn-success" value="ยืนยันข้อมูลถูกต้อง">
    
    <a href='checkInternships.php'><input type="button" class="btn btn-danger" value="ย้อนกลับ"> </a>
    </form>
    </center>
  </div>
  </div>
