...
<html lang="en">
<head>
  <title>เพิ่มสถานประกอบการ</title>
  <meta charset="utf-8">
...
<div class="container">
  ...
  <center><h2>สถานประกอบการ</h2></center>
...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="officeNme" required>
  </div>
  </div>
...
<div class="row">
  ...
  <div class="col-sm-4">
  <div class="form-group"> 
    <label>ที่อยู่ &nbsp</label>
    <input type="text" class="form-control" name="officeAddress" required> 
  </div>
  </div>
  ...
  <div class="form-group">
    <label for="province">จังหวัด</label>
         <select class='chosen-select' name="province" required>
           ...
           <option value="บึงกาฬ">บึงกาฬ</option>              <option value="บุรีรัมย์">บุรีรัมย์</option>
           ...
           <option value="พะเยา">พะเยา</option>               <option value="พระนครศรีอยุธยา">พระนครศรีอยุธยา</option>
...
<div class="row">
  ...
  <div class="col-sm-6">
  <div class="form-group">
    <label>เบอร์ติดต่อสถานประกอบการ &nbsp</label>
...
<div class="row">
  ...
  <div class="form-group">
    <center>
    <input type="submit" name="insertOffice" class="btn btn-primary" value="บันทึก">
    </center>
  </div>
  </div>
