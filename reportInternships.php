...
// ======================ข้อมูลแยกตามสาขางาน=================================
        $sql = "SELECT *  FROM internships WHERE years LIKE '%".$search."%'
                ORDER BY years ASC"  ;
        $result = $conn->query($sql);

        $sql2 = "SELECT *  FROM internships WHERE years LIKE '%".$search."%'
 ...
 <!-- =============================================================================== -->
    ...
    <script>
         Highcharts.chart('barChat1', {
            ...
            title: {
                text: 'แผนภูมิแท่งแสดงจำนวนของนักศึกษาฝึกงาน แยกตามสาขางาน'
            },
            yAxis: {
                allowDecimals: false,
                    title: {
    ...
    Highcharts.chart('pieChat1', {
        ...
        title: {
         text: 'แผนภูมิวงกลมแสดงอัตราส่วนของนักศึกษาฝึกงาน แยกตามสาขางาน'
        },
        tooltip: {
    ...
    <script>
         Highcharts.chart('barChat2', {
            ...
            title: {
                text: 'แผนภูมิแท่งแสดงจำนวนของนักศึกษาฝึกงาน แยกตามภูมิภาคของสถานที่ฝึกงาน'
            },
            yAxis: {
                allowDecimals: false,
                    title: {
    ...
    Highcharts.chart('pieChat2', {
        ...
        title: {
         text: 'แผนภูมิวงกลมแสดงอัตราส่วนของนักศึกษาฝึกงาน แยกตามภูมิภาคของสถานที่ฝึกงาน'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
