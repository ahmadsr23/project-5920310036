...
<html lang="en">
<head>
<title>ข้อมูลการฝึกสหกิจศึกษา</title>
  <meta charset="utf-8">
...
echo "<h2>การฝึกสหกิจของนักศึกษา หลักสูตรสาขาคณิตศาสตร์ประยุกต์</h2>";
echo "<br>";

echo "<form name='search' action='showCooperativeTraining.php' method='post'>";
echo "<div class='row'>";
...
echo "</tr>";
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo "<form action='detaliCooperativeTraining.php' method='post' target='_blank'>";
        echo "<td> <a href='detaliCooperativeTraining.php' >
...
echo "<tr style = 'text-align: center;'><td style = 'text-align: center;'>";
	echo"<form name='divide' action = 'showCooperativeTraining.php' method ='post'> ";
