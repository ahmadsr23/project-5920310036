 ...
 <!-- =============================================================================== -->
    ...
    <script>
         Highcharts.chart('barChat1', {
            ...
            title: {
                text: 'กราฟแสดงจำนวนของนักศึกษาฝึกสหกิจศึกษา แยกตามสาขางาน'
            },
            yAxis: {
                allowDecimals: false,
                    title: {
    ...
    Highcharts.chart('pieChat1', {
        ...
        title: {
         text: 'อัตราส่วนของนักศึกษาฝึกสหกิจศึกษา แยกตามสาขางาน'
        },
        tooltip: {
    ...
    <script>
         Highcharts.chart('barChat2', {
            ...
            title: {
                text: 'กราฟแสดงจำนวนของนักศึกษาฝึกสหกิจศึกษา แยกตามภูมิภาคของสถานที่ฝึกสหกิจศึกษา'
            },
            yAxis: {
                allowDecimals: false,
                    title: {
    ...
    Highcharts.chart('pieChat2', {
        ...
        title: {
         text: 'อัตราส่วนของนักศึกษาฝึกสหกิจศึกษา แยกตามภูมิภาคของสถานที่ฝึกสหกิจศึกษา'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
      ...
      <script>
         Highcharts.chart('barChat3', {
            ...
            title: {
                text: 'กราฟแสดงจำนวนของนักศึกษาฝึกสหกิจศึกษาและไม่ฝึกสหกิจ ตามปีการศึกษา'
            },
            yAxis: {
                allowDecimals: false,
                    title: {
    ...
    Highcharts.chart('pieChat3', {
        ...
        title: {
         text: 'อัตราส่วนของนักศึกษาาฝึกสหกิจศึกษาและไม่ฝึกสหกิจ ตามปีการศึกษา'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },
